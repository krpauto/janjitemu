    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm border-bottom-primary">
                ...
                <div class="card-body">
                    <form action="<?= base_url('petugas/edit_aksi') ?>" method="post" accept-charset="utf-8">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input value="<?= $petugas->nama_petugas ?>" name="nama_petugas" id="nama_petugas" type="text" class="form-control" placeholder="Nama Petugas">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input value="<?= $petugas->no_telp ?>" name="no_telp" id="no_telp" type="text" class="form-control" placeholder="Nomor Telepon">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control" rows="4" placeholder="Alamat"><?= $petugas->alamat ?></textarea>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input value="<?= $petugas->id_berkas ?>" name="id_berkas" id="id_berkas" type="textarea" class="form-control" placeholder="Nomor Berkas Pemohon">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <textarea name="nip_petugas" id="nip_petugas" class="form-control" placeholder="NIP Petugas"><?= $petugas->nip_petugas ?></textarea>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input value="<?= $petugas->jabatan ?>" name="jabatan" id="jabatan" type="text" class="form-control" placeholder="jabatan">
